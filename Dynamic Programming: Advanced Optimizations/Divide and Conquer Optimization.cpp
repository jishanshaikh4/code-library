...
// Divide 1,2,3...n people in k consecutive parts so that sum of cost of each
// individual part is minimum
int a[N][N], c[N][N],
    dp[810][N]; // dp[i][j]=minimum cost for dividing [1...j] into i parts
